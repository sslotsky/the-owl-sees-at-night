...
export type CreatePaymentAttemptMutationVariables = Exact<{ [key: string]: never; }>;


export type CreatePaymentAttemptMutation = { __typename?: 'Mutation', createStripePaymentIntent?: string | null };
...
export type SetOrderStatusMutation = { __typename?: 'Mutation', transitionOrderToState?: { __typename: 'Order' } | { __typename: 'OrderStateTransitionError' } | null };
...
export type CustomPrintQueryVariables = Exact<{
  slug?: InputMaybe<Scalars['String']>;
}>;
...
export const CreatePaymentAttemptDocument = gql`
...
export const SetOrderShippingAddressDocument = gql`
  ...
  setOrderShippingAddress(input: $input) {
    ...
    `;
export const SetCustomerDetailsDocument = gql`
...
export const AddToOrderDocument = gql`
  ...
  addItemToOrder(
    ...
    `;
export const CustomPrintDocument = gql`
...
export function getSdk<C, E>(requester: Requester<C, E>) {
  return {
    CreatePaymentAttempt(variables?: CreatePaymentAttemptMutationVariables, options?: C): Promise<CreatePaymentAttemptMutation> {
      return requester<CreatePaymentAttemptMutation, CreatePaymentAttemptMutationVariables>(CreatePaymentAttemptDocument, variables, options) as Promise<CreatePaymentAttemptMutation>;
    },
    SetOrderStatus(variables: SetOrderStatusMutationVariables, options?: C): Promise<SetOrderStatusMutation> {
      return requester<SetOrderStatusMutation, SetOrderStatusMutationVariables>(SetOrderStatusDocument, variables, options) as Promise<SetOrderStatusMutation>;
    },
    ...
    SetCustomerDetails(variables: SetCustomerDetailsMutationVariables, options?: C): Promise<SetCustomerDetailsMutation> {
      return requester<SetCustomerDetailsMutation, SetCustomerDetailsMutationVariables>(SetCustomerDetailsDocument, variables, options) as Promise<SetCustomerDetailsMutation>;
    },
    ...
    AddToOrder(variables: AddToOrderMutationVariables, options?: C): Promise<AddToOrderMutation> {
      return requester<AddToOrderMutation, AddToOrderMutationVariables>(AddToOrderDocument, variables, options) as Promise<AddToOrderMutation>;
    },
    CustomPrint(variables?: CustomPrintQueryVariables, options?: C): Promise<CustomPrintQuery> {
      return requester<CustomPrintQuery, CustomPrintQueryVariables>(CustomPrintDocument, variables, options) as Promise<CustomPrintQuery>;
    }
  };
}
