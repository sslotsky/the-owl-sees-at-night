...
export default component$((props: {
  ...
  const { execute$, result } = addToOrder(store.variant.id, 1, store.file.fileId, transform)
    ...
    <div class="custom-prints">
      ...
      <div class="options-selector">
        <div class="preview-area graph-paper">
          <div class="controls">
            <div class="buttons">
              <button class="iconic" disabled={store.gridView || result.loading} onClick$={execute$}>
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
