...
export type ActiveOrderQuery = { __typename?: 'Query', activeOrder?: { __typename?: 'Order', id: string, code: string, state: string, couponCodes: Array<string>, subTotalWithTax: number, shippingWithTax: number, totalWithTax: number, totalQuantity: number, lines: Array<{ __typename?: 'OrderLine', id: string, quantity: number, linePriceWithTax: number, productVariant: { __typename?: 'ProductVariant', id: string, name: string }, featuredAsset?: { __typename?: 'Asset', id: string, preview: string } | null }> } | null };
