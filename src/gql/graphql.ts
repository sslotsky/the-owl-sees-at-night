...
export type ActiveOrderQuery = { __typename?: 'Query', activeOrder?: { __typename?: 'Order', id: string, code: string, state: string, couponCodes: Array<string>, subTotalWithTax: number, shippingWithTax: number, totalWithTax: number, totalQuantity: number, lines: Array<{ __typename?: 'OrderLine', id: string, previewUrl: string, quantity: number, linePriceWithTax: number, productVariant: { __typename?: 'ProductVariant', id: string, name: string, price: number, customFields?: { __typename?: 'ProductVariantCustomFields', height?: number | null, width?: number | null, material?: string | null } | null }, customFields?: { __typename?: 'OrderLineCustomFields', fileId?: string | null, transformation?: string | null } | null }> } | null };
